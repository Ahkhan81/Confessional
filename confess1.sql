...
VALUES
('Administration', 1), ('Events', 1), ('SGA', 1), ('Majors', 1);
...
select msg_text, username from message m, users u where category_id = 7 and u.user_id = 4 and u.user_id = m.user_id;
select msg_text, user_id from message where category_id = 7;
select * from message; 
